...
とにかくお店や商品の雰囲気が伝わるカッコイイサイトにして欲しいとご要望を頂いたので、写真を際立たせるようにし、JavaScriptでのスクロールアニメーションやSwiperを使って動きをつけることに力を注ぎました。
サイトの構成は自社ブランドやビンテージ商品によってページを分け、それぞれのブランドのコンセプトや雰囲気を伝え、ECサイトへ誘導できるように設計しました。
独自ドメイン取得やサーバーとの契約もやらせていただき、その後のSEO対策にも取り組みました。
